...
namespace InvoiceAutomation.Migrations
{
    ...
    [Migration("20260220120000_AddGLAccountsAndPostToGL")]
    partial class AddGLAccountsAndPostToGL
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InvoiceAutomation.Core.Entities.Invoice", b =>
                {
                    ...
                    b.Property<Guid?>("AdvanceTaxAccountId")
                        .HasColumnType("CHAR(36)")
                    ...
                    b.Property<DateTime?>("PostedToGLAt")
                        .HasColumnType("DATETIME")
                        .HasColumnName("posted_to_gl_at");

                    b.Property<Guid?>("PostedToGLBy")
                        .HasColumnType("CHAR(36)")
                        .HasColumnName("posted_to_gl_by");
            ...
            modelBuilder.Entity("InvoiceAutomation.Core.Entities.VendorInvoiceTemplate", b =>
                {
                    ...
                    b.Property<Guid?>("DefaultAdvanceTaxAccountId")
                        .HasColumnType("CHAR(36)")
                        .HasColumnName("default_advance_tax_account_id");
                    ...
                    b.Property<bool>("HasAdvanceTaxAccount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TINYINT(1)")
                        .HasDefaultValue(true)
                        .HasColumnName("has_advance_tax_account");
                    ...
                    b.Property<bool>("HasSalesTaxInputAccount")
                        ...
                        .HasColumnType("TINYINT(1)")
                        .HasDefaultValue(true)
                        .HasColumnName("has_sales_tax_input_account");
            ...
            modelBuilder.Entity("InvoiceAutomation.Core.Entities.Invoice", b =>
                {
                    b.HasOne("InvoiceAutomation.Core.Entities.ChartOfAccount", "AdvanceTaxAccount")
                        .WithMany()
                        .HasForeignKey("AdvanceTaxAccountId")
            ...
            modelBuilder.Entity("InvoiceAutomation.Core.Entities.VendorInvoiceTemplate", b =>
                {
                    b.HasOne("InvoiceAutomation.Core.Entities.ChartOfAccount", "DefaultAdvanceTaxAccount")
                        .WithMany()
                        .HasForeignKey("DefaultAdvanceTaxAccountId")
                        .OnDelete(DeleteBehavior.SetNull);
